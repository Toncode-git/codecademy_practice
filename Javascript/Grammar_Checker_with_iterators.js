/*
This is how you can edit an array with iterators with call back functions
*/
...
let breath = storyWords.findIndex((w) => {
   return w === 'breathtaking' ? w.indexOf : false;
  });
